...
export const mokEmploymentTypesData = [
...
export const mokPreferredIndustriesData = [
...
export const workFormatOptions = [
  ...
  { value: '2', label: 'Только в офисе' },
  { value: '3', label: 'Гибридный формат' },
];
