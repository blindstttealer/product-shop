...
import type {
  LoginUserDto,
  RegisterUserDto,
  UserControllerGetMe200,
  UserControllerGetProfile200,
  UserControllerGetUsers200Item,
  UserControllerLogin200,
} from '../model';
...
export const userControllerLogin = (
  ...
  return customInstance<UserControllerLogin200>(
    {
      url: `/api/user/login`,
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export const userControllerGetMe = (
  ...
  return customInstance<UserControllerGetMe200>(
...
export const userControllerGetUsers = (
  ...
  return customInstance<UserControllerGetUsers200Item[]>(
    { url: `/api/user/users`, method: 'GET', signal },
    options,
  );
};
